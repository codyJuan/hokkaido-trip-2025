...
function main() {
  ...
  const galleryImages = scanLooseFolder(path.join(INPUT_DIR, "_gallery"), "./images/_gallery");
  const friendsPhotos = scanLooseFolder(path.join(INPUT_DIR, "_friends"), "./images/_friends");
